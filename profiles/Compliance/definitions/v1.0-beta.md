...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      /compliance/ediscovery/cases/{case-id}/sourceCollections/{sourceCollection-id}/custodianSources/{dataSource-id}/$ref: v1.0-beta
      ...
      ? /compliance/ediscovery/cases/{case-id}/sourceCollections/{sourceCollection-id}/noncustodialSources/{noncustodialDataSource-id}/$ref
      : v1.0-beta
      ...
      /compliance/ediscovery/cases/{case-id}/tags/{tag-id}/childTags/{tag-id1}/$ref: v1.0-beta
