...
profiles:
  v1.0-beta:
    ...
    operations:
      ...
      /planner/rosters/{plannerRoster-id}/plans/{plannerPlan-id}/$ref: v1.0-beta
      ...
      /users/{user-id}/planner/favoritePlans/{plannerPlan-id}/$ref: v1.0-beta
      ...
      /users/{user-id}/planner/recentPlans/{plannerPlan-id}/$ref: v1.0-beta
      /users/{user-id}/planner/recentPlans/$ref: v1.0-beta
      /users/{user-id}/planner/rosterPlans: v1.0-beta
      /users/{user-id}/planner/rosterPlans/{plannerPlan-id}/$ref: v1.0-beta
